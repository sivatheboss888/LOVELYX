...
from LOVELYX.modules import ALL_MODULES
from LOVELYX.modules.helper_funcs.chat_status import is_user_admin
from LOVELYX.modules.helper_funcs.misc import paginate_modules
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if LOVELY_OWNER != 1677365574 and DONATION_LINK:
            update.effective_message.reply_text(
