...
from LOVELYX import BOT_ID
from LOVELYX.conf import get_int_key, get_str_key

from LOVELYX.pyrogramee.telethonbasics import is_admin
from LOVELYX.events import register
from LOVELYX import MONGO_DB_URI 
...
__help__ = """
<b> Group Guardian: </b>
♛ Lovely can protect your group from NSFW senders, Slag word users and also can force members to use English
<b>Commmands</b>
